...
var zR2Messages = z2.array(z2.string()), zR2Errors = z2.array(
  ...
  result: z2.unknown().nullable(),
  success: z2.literal(!1)
}), zD1DatabaseVersion = z2.string().regex(/^(alpha|beta|production)$/), zD1DatabaseName = z2.string().regex(/^[a-zA-Z0-9][a-zA-Z0-9_-]*$/), zD1JurisdictionNullable = z2.enum(["eu", "fedramp"]), zD1DatabaseResponse = z2.object({
...
}), zWorkersKvKeyNameBulk = z2.string().max(512), zWorkersKvBulkDelete = z2.array(zWorkersKvKeyNameBulk), zWorkersKvBulkResult = z2.object({
...
]).nullable(), zWorkersKvBulkDeleteWritable = z2.array(zWorkersKvKeyNameBulk), zWorkersKvListMetadataWritable = zWorkersKvAnyWritable.and(
  z2.unknown()
...
), zWorkflowsChangeInstanceStatusData = z2.object({
  body: z2.object({
    action: z2.enum(["pause", "resume", "restart", "terminate"]),
    from: z2.object({
      name: z2.string(),
      count: z2.int().gte(1).optional(),
