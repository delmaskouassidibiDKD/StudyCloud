...
export const ClockMenuView: React.FC<ClockMenuViewProps> = ({ onBack }) => {
  ...
  return (
    <div className="absolute inset-x-0 bottom-0 top-[56px] md:top-[60px] md:left-64 z-30 w-full md:w-[calc(100%-16rem)] bg-[#F5F0E8] text-[#2D4A3E] px-3 sm:px-6 py-6 overflow-y-auto min-h-[calc(100vh-60px)] flex flex-col">
      ...
      <div className="w-full max-w-4xl mx-auto pt-14 pb-12 flex-1 flex flex-col">
