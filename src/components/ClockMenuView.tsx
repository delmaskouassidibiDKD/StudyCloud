...
export const ClockMenuView: React.FC<ClockMenuViewProps> = ({ onBack }) => {
  ...
  return (
    <div className="absolute inset-x-0 bottom-0 top-[56px] md:top-[60px] z-30 w-full bg-[#F5F0E8] text-[#2D4A3E] px-3 sm:px-6 py-6 overflow-y-auto min-h-[calc(100vh-60px)] flex flex-col">
